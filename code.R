...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstlgl ~ ., data = panel_data, model = "within")
summary(FE_model)
...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstplc ~ ., data = panel_data, model = "within")
summary(FE_model)
...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstplt ~ ., data = panel_data, model = "within")
summary(FE_model)
...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstprt ~ ., data = panel_data, model = "within")
summary(FE_model)
...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstep ~ ., data = panel_data, model = "within")
summary(FE_model)
...
#FIXED EFFECTS MODEL 
panel_data <- pdata.frame(selected_data, index = c("full_dataset.idno"))
FE_model <- plm(full_dataset.trstun ~ ., data = panel_data, model = "within")
summary(FE_model)
